...
// ── Browser Cleaner ────────────────────────────────────────────────────────────
// Used to scan/clear each browser's Android/data/<pkg>/cache directly, but Android's
// scoped storage blocks any third-party app from reading or writing another app's
// Android/data folder — so this always scanned 0 bytes and never actually freed
// anything. The only honest, working option is the same one "Bersihkan Cache Semua
// App" already uses: hand the user off to the OS's own storage cleaner.
